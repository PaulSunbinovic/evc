...
$.ajax({
    ...
    'success': function(data) {
    		for(var i=0;i<data['dvcls'].length;i++){
				...
				"<p style='margin:0;line-height:1.5;font-size:13px;text-indent:2em'>惠充电智能充电桩。惠充电智能充电桩。惠充电智能充电桩。惠充电智能充电桩。惠充电智能充电桩。</p>" + "<div class='infwdaptmt'><div><a class='pull-left btn btn-success' onclick='apnt("+dvcid+")'><i class='glyphicon glyphicon-time'></i> 预约</a><a class='pull-left btn btn-warning' href='"+__url__+"/cmnt/dvcid/"+dvcid+"' style='margin-left:5px'><i class='glyphicon glyphicon-comment'></i> 评论</a></div></div>"
				+
				"</div>";
				var infoWindow = new BMap.InfoWindow(sContent);  // 创建信息窗口对象
				lct(p[dvcid],infoWindow,'','','','',ads);
    		}
