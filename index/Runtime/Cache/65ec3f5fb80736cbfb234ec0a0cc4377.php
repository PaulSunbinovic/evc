...
<!--导航结束-->
	...
	<!--<div class='col-md-12 col-xs-12 bd' style='padding-top:10px'>
		<div class='col-md-6 col-xs-6'><a class='btn btn-success btn-block' href='#'>预约记录</a></div>
		<div class='col-md-6 col-xs-6'><a class='btn btn-default btn-block' href='__URL__/hstr_pay'>充值记录</a></div>
	</div>-->

	<div class='col-md-12 col-xs-12' style='position:fixed;top:40px;z-index: 1000;border-bottom: 1px solid #ccc;height:50px;text-align: center;line-height: 50px;'>
		...
		<div class='col-md-4 col-xs-4 nopadding'>创建时间</div>
		...
		<div id="scroller">
			...
			var odrls=new Array();
				...
				<?php if(is_array($odrls)): $i = 0; $__LIST__ = $odrls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$odrv): $mod = ($i % 2 );++$i;?><script type="text/javascript">
					...
					<li onclick="showdtl(<?php echo ($odrv['id']); ?>)" style="line-height: 80px;">
						<div class='col-md-12 col-xs-12'>
							...
							<div class='col-md-4 col-xs-4 nopadding'><?php echo ($odrv['createTime']); ?></div>
							<div class='col-md-2 col-xs-2 nopadding'><?php echo ($odrv['totalPrice']); ?></div>
							<div class='col-md-2 col-xs-2 nopadding' style='padding-left:20px;'>
							<?php if($odrv['stat']=='1'){ ?>
